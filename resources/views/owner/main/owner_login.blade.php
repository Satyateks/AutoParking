        ...
        <div class="row" style="align-items: center;">
            <div class="col-lg-6 form-column pt-5 pb-5">
                <div class="img-section">
                    ...
                    <h5 class="pt-5">Login Your Account and <br> List your rent space</h5>
                </div>
            </div>
            ...
            <div class="col-lg-4 form-column2 pt-5">
                <div class="form-section">
                    ...
                    <h5>Welcome to owner login
                    <h6>Please login to access your account.</h6>
                    <form class="" action="{{ url('onwer_login_post') }}" method="POST" data-parsley-validate>
                        @csrf
                        <div class="mb-4 pt-3">
                          ...
                          <div class="mb-4">
                            ...
                            <span class="forgot-password"> <a href="{{ url('password_update1') }}"> Forgot Password </a></span>
                          </div>

                      <button class="mt-4">Login</button>
                    </form>
                      <div class="text-center center-para pt-3">
                        <p>Don't have an account? <a href="{{ url('onwer_registration') }}">Sign Up</a> </p>
                      </div>

                      <div class="text-center center-para pt-3">
                        <p>If you want login as user click here! <a href="{{ url('user_login') }}">Login</a> </p>
                      </div>
                </div>
            </div>
            <div class="col-lg-1"></div>
