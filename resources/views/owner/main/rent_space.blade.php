            ...
            <div class="col-lg-6 right-space-column">
                <div class="row space-image-row">
                    <div class="col-lg-8 pt-5 pb-5">
                        <form id="regForm" action="{{ url('rent_space_post') }}" method="POST"
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-5">
                                    ...
                                    <p><input type="number" placeholder="Zip Code" name="zip_code" class="form-control"
                                            required maxlength="6" minlength="6"></p>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="vehicle-size">
                                        <div class="radio-class">
                                            <div class="form-check radio-check me-1">
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-4 pb-2">
                                    ...
                                    <div class="select-btns pt-1">
                                        <button type="button" class="me-3 d-flex">
                                            <div class="form-check radio-check me-1">
                                                <input class="form-check-input" type="radio" value="0"
                                                    name="flexRadioDisabled1" id="flexRadioDisabled" checked>
                                            </div> Yes
                                        </button>
                                        <button type="button" class="me-3 d-flex">
                                            <div class="form-check radio-check me-1">
                                                <input class="form-check-input" type="radio" value="1"
                                                    name="flexRadioDisabled1" id="flexRadioDisabled">
                                            </div> No
                                        </button>
                                    </div>
                                </div>
                                <div class="mb-5">
                                    ...
                                    <div class="select-btns pt-1">
                                        <button type="button" class="me-3 d-flex">
                                            <div class="form-check radio-check me-1">
                                                <input class="form-check-input" type="radio" value="0"
                                                    name="flexRadioDisabled2" id="flexRadioDisabled1" checked>
                                            </div> Yes
                                        </button>
                                        <button type="button" class="me-3 d-flex">
                                            <div class="form-check radio-check me-1">
                                                <input class="form-check-input" type="radio" value="1"
                                                    name="flexRadioDisabled2" id="flexRadioDisabled1">
                                            </div> No
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-5 radio-check">
                                    ...
                                    <div class="row booking-type radio-booking-type"
                                        style=" --bs-gutter-x: 1px !important;">
                                        <div class="radio-btn col-1"><input class="form-check-input mt-3" value="1"
                                                name="name" type="radio" id="flexRadioDefault1" checked></div>
                                        <div class="col-11">
                                    ...
                                    <div class="row booking-type radio-booking-type"
                                        style=" --bs-gutter-x: 1px !important;">
                                        <div class="radio-btn col-1"><input class="form-check-input mt-3" value="2"
                                                name="name" type="radio" id="flexRadioDefault2"></div>
                                        <div class="col-11">
                                    ...
                                    <div class="row booking-type radio-booking-type"
                                        style=" --bs-gutter-x: 1px !important;">
                                        <div class="radio-btn col-1"><input class="form-check-input mt-4" value="3"
                                                name="name" type="radio" id="flexRadioDefault3"></div>
                                        <div class="col-11">
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-5">
                                    <div class="mb-5">
                                        ...
                                        <div id="locationInfo" style="display: block;height:auto;"></div>
                                        ...
                                        <p>
                                            ...
                                            <input disabled type="text" name="country" id="country" class="form-control" />
                                            {{-- <select class="form-select" aria-label="Default select example"
                                                id="country" name="country" required>
                                                <option>United States</option>
                                                @foreach ($countries as $country)
                                                    <option
                                                        {{ old('country') == $country->id || $country->name == 'United state' ? 'selected' : '' }}
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input disabled type="text" name="state" id="state" class="form-control" />
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p><input placeholder="Enter your city" name="city" id="city" class="form-control"
                                                required maxlength="45"></p>
                                    </div>

                                    <label for="">Full Address</label>
                                    <p>
                                      <input placeholder="456 North Anderson Drive Aberdeen, AB16 7GL" name="address"
                                            class="form-control" id="address" required maxlength="45">
                                    </p>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="tab">
                        ...
                        <div class="mb-5">
                            <div class="mb-5">
                                ...
                                <p><input type="number" placeholder="" name="latitude" id="latitude" class="form-control" required
                                        maxlength="25"></p>
                            </div>
                            <label for="">Longitude</label>
                            <p><input type="number" placeholder="" name="longitude" id="longitude" class="form-control"
                                    data-parsley-required="" required maxlength="25"></p>
                        </div>
                    </div>
                    ...
                    <div class="tab">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="space-pricing">
                                ...
                                <div>
                                    <input type="number" name="hour" class="form-control" placeholder="$ 1.30"
                            ...
                            <div class="space-pricing">
                                ...
                                <div>
                                    <input type="number" name="daily" class="form-control" placeholder="$ 1.30"
                                        required maxlength="7">
                                </div>
                            </div>
                            <div class="space-pricing">
                                ...
                                <div>
                                    <input type="number" name="weekly" class="form-control" placeholder="$ 1.30"
                                        required maxlength="7">
                                </div>
                            </div>
                            <div class="space-pricing">
                                ...
                                <div>
                                    <input type="number" name="monthly" class="form-control" placeholder="$ 1.30"
                                        required maxlength="7">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="textarea" class="form-control" id="description" name="description"
                                rows="3"
                                placeholder="1 space located on North Anderson Drive in Aberdeen. The space is big enough to fit large vehicles"
                                required maxlength="200" minlength="30" required></input>
    ...
    <script>
        function initMap() {
            ...
            var marker = new google.maps.Marker({
                position: {
                    lat: 38.868226151, lng: -102.227783203
                },
                map: map,
                draggable: true
            });
            ...
            function getLocationInfo() {
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        // locationInfoDiv.innerHTML = '<p>Village/Town: ' + data.city + '</p>' +
                        //     '<p>City: ' + data.district + '</p>' +
                ...
                // fetch('/auto_park/public/get-location?latitude=' + latitude + '&longitude=' + longitude)
                //     .then(response => response.json())
                //     .then(data => {
                //         console.log('map data : ', data);
                //         var locationInfoDiv = document.getElementById('locationInfo');
                //         locationInfoDiv.innerHTML = '<p>City: ' + data.city + '</p>' +
                //             '<p>State: ' + data.state + '</p>' +
                //             '<p>Country: ' + data.country + '</p>';
                //     })
                //     .catch(error => {
