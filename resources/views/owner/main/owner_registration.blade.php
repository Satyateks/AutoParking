        ...
        <div class="row">
            <div class="col-lg-6 form-column pt-5 pb-5">
                <div class="img-section">
                    ...
                    <h5 class="pt-5">Register Your Account and <br> List your rent space</h5>
                </div>
            </div>
            ...
            <div class="col-lg-4 form-column2 pt-2">
                <div class="form-section">
                    ...
                    <h5>Welcome to owner register page!</h5>
                    <h6>Please register to access your account.</h6>
                    <form class="" action="{{ url('onwer_register_otp') }}" method="POST" data-parsley-validate>
                        @csrf
                        {{-- <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="exampleInputEmail1" class="form-label">Full Name</label>
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Full Name" required data-parsley-whitespace="squish" data-parsley-pattern="^[A-Za-z\s]+$" data-parsley-pattern-message="Please enter a valid name without numbers or special characters.">
                        </div>
                      ...
                      <div class="text-center center-para pt-3">
                        <p> Already have an account? <a href="{{ url('owner_login') }}">Sign in</a> </p>
                      </div>
                </div>
            </div>
            <div class="col-lg-1"></div>
