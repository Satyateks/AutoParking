...
<section class="home">
    ...
    <div class="Container pt-3">
        <div class="row foot-tablerow">
            <h5>Storage Company Slider</h5>
            <div class="col-lg-10 maintable-column">
                <div class="add-btntest">
                    <a href="{{ url('add_cru_test') }}"><i class="fa-solid fa-plus"></i> &nbsp; Add New</a>
                </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->comment }}</td> --}}
                                <td>
                                    <a href="{{ url('add_cru_edit/'.$item->id) }}"><i class="fa-regular fa-pen-to-square"></i></a>

                                    &nbsp;
                                    <a href="{{ url('add_cru_delete/'.$item->id) }}">
                                        <i
