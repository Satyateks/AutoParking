                  ...
                  <div class="filter-box">
                    <h5> Document KYC details</h5>
                      <table id="example">
                          ...
                          <td colspan="1" class="hide-rowline">{{ $item->fname }}</td>
                              <td colspan="1" class="hide-rowline">
                               {{ $item->address }}
                              </td>
                           <td colspan="1" class="hide-rowline">
                          ...
                          <td colspan="1" class="hide-rowline">
                                <a href="{{asset('images_uploade/'.$item->adhar_front)}}" download="">
                                  <img src="{{asset('images_uploade/'.$item->adhar_front)}}" alt="" width="100px" height="100px">
                                </a>
                              </td>

                              <td colspan="1" class="hide-rowline">
                                <a href="{{asset('images_uploade/'.$item->adhar_back)}}" download>
