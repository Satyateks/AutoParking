        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="kyc-form">
                    ...
                    <form id="kycForm" class="row pt-4" action="{{ url('admin_parking_edit/' . $id->id) }}" method="POST"
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="number" class="form-control" id="fullName" name="value1"
                                value="{{ $id->zip_code }}" required
                                title="Only alphabetic characters and spaces are allowed" data-parsley-required="" maxlength="6" minlength="6">
                                ...
                                <div class="mb-5 radio-check">
                                    ...
                                    @if ($id->booking_want == '1')
                                        <div class="row booking-type radio-booking-type"
                                            ...
                                            <div class="radio-btn col-1"><input class="form-check-input mt-3"
                                                    value="1" name="name" type="radio" id="flexRadioDefault1"
                                                    checked></div>
                                            <div class="col-11">
                                        ...
                                        <div class="row booking-type radio-booking-type"
                                            style=" --bs-gutter-x: 1px !important;">
                                            <div class="radio-btn col-1"><input class="form-check-input mt-3"
                                                    value="2" name="name" type="radio" id="flexRadioDefault2">
                                            </div>
                                            <div class="col-11">
                                        ...
                                        <div class="row booking-type radio-booking-type"
                                            style=" --bs-gutter-x: 1px !important;">
                                            <div class="radio-btn col-1"><input class="form-check-input mt-4"
                                                    value="3" name="name" type="radio" id="flexRadioDefault3">
                                            </div>
                                            <div class="col-11">
                        ...
                        <div class="mb-5">
                            ...
                            <p><input placeholder="456 North Anderson Drive Aberdeen, AB16 7GL"
                                    h value="{{ $id->address }}" name="address"
                                    value="{{ $id->address }}" class="form-control" data-parsley-maxlength="26"></p>
                            ...
                            <div class="mb-5">
                                <div class="mb-5">
                                    ...
                                    <p><input type="text" placeholder="" h
                                            name="lat" value="{{ $id->lat }}" class="form-control" required maxlength="20" min="-90" max="90"></p>
                                </div>
                                <label for="">Longitude</label>
                                <p><input type="text" placeholder="" h
                                        name="lng" value="{{ $id->lng }}" class="form-control" required maxlength="20" min="-180" max="180"></p>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="space-pricing">
                                    ...
                                    <div>
                                        <input type="number" name="hour" value="{{ $id->hourly ?? '' }}"
                                            class="form-control"
                                            placeholder="$ 1.30"
                                ...
                                <div class="space-pricing">
                                    ...
                                    <div>
                                        <input type="number" name="daily" value="{{ $id->daily }}"
                                            class="form-control"
                                            placeholder="$ 1.30"
                                            required maxlength="11">
                                    </div>
                                ...
                                <div class="space-pricing">
                                    ...
                                    <div>
                                        <input type="number" name="weekly" value="{{ $id->weekly }}"
                                ...
                                <div class="space-pricing">
                                    ...
                                    <div>
                                        <input type="number" name="monthly" value="{{ $id->monthly }}"
                                            class="form-control"
                                            placeholder="$ 1.30"
                                            required maxlength="11"
                                           >
                            ...
                            <div class="mb-5">
                                <img src="{{ asset('images_uploade/' . $id->image) }}" width="100px" height="100px"
                                    alt="">
               ...
               <input type="file" name="image" value="{{ $id->image }}" h class="form-control" style="height: auto;" required>
            </div> --}}
                            ...
                            <div class="mb-5">
                                ...
                                <input type="file" id="imageInput" name="image"
                                    h class="form-control" style="height: auto;">
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"
                                    ...
                                    data-parsley-required="true" data-parsley-maxlength="400" maxlength="250" minlength="30" required>{{ $id->description }}</textarea>
                            </div>
                            ...
                            {{-- <div class="kyc-buttons pt-3">
                                ...
                                <button class="kyc-back-btn"><a href="{{ url('owner_parking/'.$id->id) }}">Back</a></button>
                            </div> --}}

                            <div class="kyc-buttons pt-3">
                                <button class="kyc-back-btn" onclick="goBack()">Back</button>
