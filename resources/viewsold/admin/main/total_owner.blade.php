                        ...
                        <table id="employeeTable" class="display">
                            ...
                            <tbody>
                                @php
                                    $i = 1;
                                @endphp
                                @foreach ($total_paking_owner as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $item->name }}</td>
                                        <td><a href="{{ url('admin_kyc/'.$item->id) }}">{{ $item->email }}</a></td>
                                        <td>{{ $item->phone }}</td>

                                        <td>
                                        <a href="{{ url('owner_parking/'.$item->id) }}">Owner parking</a>
                                        </td>
                                        {{-- <td>
                                        ...
                                        <th>
                                            <a href="{{ url('admin_kyc/'.$item->id) }}">KYC details</a>
                                        </th>
                                        <td>
                                            @if ($item->is_verify == 0)
                                            <a href="{{ url('total_user_edit1_post/'.$item->id) }}">
