                            ...
                            <tbody>
                                ...
                                <tr>
                                   <td scope="row">{{$key+1}}</td>
                                    <td>{{$value->owners->name ?? ""}}</td>
                                    <td>{{$value->owners->email ?? ""}}</td>
                                    <td>{{$value->bookings}}</td>
                                    <td>{{$value->amount}}</td>
                                    <td>{{$value->start_date}}</td>
                                    <td>{{$value->end_date}}</td>
                                    <td>{{$value->status}} @if($value->status == "Unpaid") <button type="button" class="btn btn-success" onclick="window.location.href='{{route('payout_status',$value->id)}}';">Paid</button> @endif</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
