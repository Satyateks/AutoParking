    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="tab-content border-primary text-danger" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active booking-column" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <!-- Content for booking in progress -->
                        ...
                        <div class="booking-detail mb-4">
                            <div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <span>&nbsp; (4.6)</span> --}}
                                    {{-- <h5>{{ $booking->owner_id }}</h5> --}}
                                    @php
                                    $ddd=DB::table('parking_space')->where('id',$booking->owner_id)->first();
                                  @endphp
                               @for ($i = 0; $i < ($ddd->final_rating ?? 0); $i++)
                               <i class="bi bi-star-fill"></i>
                                 @endfor
                             <span>&nbsp; ({{($ddd->final_rating ?? 0)}})</span>
                ...
                <div class="tab-pane fade booking-column" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                ...
                <div class="tab-pane fade booking-column" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
