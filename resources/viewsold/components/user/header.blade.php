...
<link rel="stylesheet" href="{{asset('admin/parsley/parsleycss.css')}}"/>
  ...
  <body>
    ...
    <nav class="index-nav">
      <div class="logo">
        <img src="{{ asset('user/images/logo.png') }}" alt="Logo Image" />
      </div>
      <div class="hamburger">
        <div class="line1"></div>
        <div class="line2"></div>
      ...
      <ul class="nav-links pt-2">
        ...
        <li><a href="{{ url('how_to_works') }}">How it Works</a></li>
      ...
      @else
          <li>
           <button class="login-button me-4 pt-2 mt-1" href="" onclick="location.href = '{{url('user_login')}}';">
            <i class="bx bxs-lock"></i> Login
            </button>
          </li>
          <li class="tel-number">
            <a href="tel:(+44) 7484878778">
